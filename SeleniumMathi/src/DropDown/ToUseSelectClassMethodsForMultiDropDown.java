...
public class ToUseSelectClassMethodsForMultiDropDown {
...
//		Thread.sleep(2000);
		MultiDropDown.deselectByIndex(1);
//		Thread.sleep(2000);
		MultiDropDown.deselectByValue("99");
//		Thread.sleep(2000);
//		MultiDropDown.deselectByVisibleText("INR 100 - INR 199 ( 16 ) ");
//		Thread.sleep(2000);
		System.out.println(MultiDropDown.getWrappedElement().getText());
